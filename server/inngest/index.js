...
//inngest function to cancel booking and release seats of show after 10 mins of
  ...
  async ({ event, step }) => {
    ...
    await sendEmail({
      ...
      body: `<div style="font-family: Arial, sans-serif; line-height: 1.5;">
          ...
          <p>
              <strong>Date:</strong> 
              ${new Date(booking.show.showDateTime).toLocaleDateString('en-US', { timeZone: 'Asia/Colombo' })}<br/>
              <strong>Time:</strong> 
              ${new Date(booking.show.showDateTime).toLocaleTimeString('en-US', { timeZone: 'Asia/Colombo' })}
          </p>
          <p>Enjoy the show! 🍿</p>
...
// inngest function to sned notification when a new show is added
