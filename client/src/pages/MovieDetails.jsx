...
const MovieDetails = () => {
  ...
  return show ? (
    <div className='px-6 md:px-16 lg:px-40 pt-30 md:pt-50'>
      <div className='flex flex-col md:flex-row gap-8 max-w-6xl mx-auto'>
        ...
        <div className='relative flex flex-col gap-3'>
          ...
          <div className='flex items-center flex-wrap gap-4 mt-4'>
            <button className='flex items-center gap-2  px-7 py-3 text-sm bg-gray-800 hover:bg-gray-900 rounded-md font-medium 
      ...
      <p className='text-lg font-medium mt-20 mb-8'>Your Favorite Cast</p>
      {show.movie.casts.length > 0 ? (
        ...
        <p className='text-gray-400 italic text-sm mt-2'>Casts not available</p>
      )}
