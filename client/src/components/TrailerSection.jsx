...
//       <p className='text-gray-300 font-medium text-lg max-w-[960px] max-auto'>Trailers</p>
...
//             h-5 md:h-12 transform -translate-x-1/2 -translate-y-1/2'/>
//           </div>
//         ))}
//       </div>
//     </div>
...
// Helper function to extract the YouTube embed URL
const getEmbedUrl = (url) => {
  const videoId = url.split('v=')[1]?.split('&')[0]; // Handles extra params safely
...
const TrailerSection = () => {
  ...
  return (
    <div className="px-6 md:px-16 lg:px-24 xl:px-44 py-20 overflow-hidden">
      ...
      <div className="relative aspect-video w-full max-w-[960px] mx-auto mt-6">
        <BlurCircle top="-100px" right="-100px" />
        <iframe
